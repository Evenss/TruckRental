...
public class DriverOrderShowActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_driver_order_show);
        initView();
        ...
        driverSwipeLayout.setOnRefreshListener(new SwipeRefreshLayout.OnRefreshListener() {
            ...
            public void onRefresh() {
                if(canRefresh){
                    ...
                    Toast.makeText(DriverOrderShowActivity.this,
        ...
        driverLeftMenu.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                ...
                {
                    case MY_INFO:
                        Intent intent = new Intent(DriverOrderShowActivity.this,
                                DriverInfoShowActivity.class);
                        startActivity(intent);
                        break;
                    case PWD_CHANGE:
                        intent = new Intent(DriverOrderShowActivity.this,
    ...
    private void initView(){
        ...
        myAdapter = new MyAdapter(DriverOrderShowActivity.this, totalList);
        ...
        public void handleMessage(android.os.Message msg)
        {
            switch (msg.what)
            {
                case REFRESH_COMPLETE:
                    totalList.clear();
                    orderDao = new OrderDao(DriverOrderShowActivity.this);
                    orderList = orderDao.findAllOrder();
                    SharedPreferences pref = getSharedPreferences("driver",MODE_PRIVATE);
                    driverDao = new DriverDao(DriverOrderShowActivity.this);
